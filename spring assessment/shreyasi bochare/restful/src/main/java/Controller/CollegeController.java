...
public class CollegeController {
	...
	// http://localhost:8080/college/allcollege
	...
	// http://localhost:8080/college/newcollege
	...
	// http://localhost:8080/college/{id}
	@GetMapping("/{id}")
	...
	// http://localhost:8080/college/college/{id}
	...
	// http://localhost:8080/college/delete/{id}
